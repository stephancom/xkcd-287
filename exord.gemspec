...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Solution for XKCD 287}
  spec.description   = %q{Exact Orders: Given a menu and a target total, come up with all possible combinations of menu items that meet that total exactly}
